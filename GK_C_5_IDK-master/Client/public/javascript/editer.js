...
//#region window init
$(window).ready(() => {
    $('#editer').submit(function (e) {
        e.preventDefault();
        $.ajax({
            url: '/editer',
            type: 'post',
            data: { cardId: $('#cardId').val(), name: $('#name').val(),
            imageUrl: $("#imageUrl").val(),cost: $("#cost").val(),attack: $("#attack").val(),
            defense: $("#defense").val(),type: $("#type").val(),text:  $("#text").val()},
            success: function () {
