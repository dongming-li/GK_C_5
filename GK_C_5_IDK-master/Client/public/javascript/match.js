...
/* button func - html use only do not use, instead use others with documentation*/

  /**
   * matchfinder button press event
   */
function matchfinder_button() {
    startGame();
}
